...
We support a complete suite of Premium plans with different durations. Each tier includes ad-free, unlimited undos, pauses, and an immediate coin bundle + daily coin allowance:
...
> [!NOTE]
> **Daily Pass Implementation**: Google Play subscriptions have a minimum billing cycle of 1 week. Therefore, the **Daily Plan** is implemented as a one-time purchase pass (Consumable) that unlocks premium features for 24 hours on the database level.
